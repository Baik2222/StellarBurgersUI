...
@allure.suite("Тестирование основной функциональности")
class TestMainFunctionality:
    ...
    @allure.title("По клику на ингредиент, появится всплывающее окно с деталями ингредиента")
    ...
    @allure.title("Кликом по крестику закрывается всплывающее окно с деталями ингредиента")
